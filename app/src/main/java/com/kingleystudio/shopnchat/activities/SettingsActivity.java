...
import com.kingleystudio.shopnchat.models.dto.AccountChangeName;
import com.kingleystudio.shopnchat.models.dto.AccountChangePassword;
import com.kingleystudio.shopnchat.models.dto.AccountLogOut;
import com.kingleystudio.shopnchat.net.SocketHelper;
import com.kingleystudio.shopnchat.models.Types;
import com.kingleystudio.shopnchat.utils.AlertUtils;
...
public class SettingsActivity extends ABCActivity implements SocketHelper.SocketListener {
    ...
    public void onCreate(Bundle b) {
        ...
        findViewById(R.id.btnLogout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    socketHelper.send(new PayloadWrapper(new AccountLogOut(Config.getDeviceID(SettingsActivity.this))));
            ...
            public void onClick(View v) {
                ...
                alert.setPositiveButton("Сменить", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!newname.isEmpty()) {
                            try {
                                socketHelper.send(new PayloadWrapper(new AccountChangeName(Config.getDeviceID(SettingsActivity.this), newname)));
                            } catch (JSONException e) {
                                throw new RuntimeException(e);
                            }
                        }
                ...
                alert.setPositiveButton("Сменить", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try {
                            ...
                            socketHelper.send(new PayloadWrapper(new AccountChangePassword(Config.currentUser.getUsername(), oldpass, newpass)));
